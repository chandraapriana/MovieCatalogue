...
import com.chandra.moviecatalogue.data.remote.IRepository
...
class Repository(
    ...
    override fun getPopularMovie(): LiveData<List<ListPopularMovieResponse>> {
    ...
    override fun getPopularSeries(): LiveData<List<ListPopularTVResponse>> {
    ...
    override fun getDetailMovie(movieId: String): LiveData<DetailMovieResponse> {
    ...
    override fun getDetailSeries(tvId: String): LiveData<DetailTVSeriesResponse> {
    ...
    override fun getFavoriteMovie(): LiveData<PagedList<DetailMovieResponse>> {
    ...
    override fun getFavoriteSeries(): LiveData<PagedList<DetailTVSeriesResponse>> {
        val config = PagedList.Config.Builder().apply {
            setEnablePlaceholders(false)
            setInitialLoadSizeHint(4)
            setPageSize(4)
    ...
    override fun insertFavoriteSeries(series: DetailTVSeriesResponse) {
        CoroutineScope(IO).launch {
            localDataSource.insertFavoriteSeries(series)
        }
    }

    override fun insertFavoriteMovie(movie: DetailMovieResponse) {
        CoroutineScope(IO).launch {
    ...
    override fun deleteFavoriteMovie(movie: DetailMovieResponse) {
        CoroutineScope(IO).launch {
    ...
    override fun deleteFavoriteSeries(series: DetailTVSeriesResponse) {
        CoroutineScope(IO).launch {
    ...
    override fun getFavoriteMovieById(id: String):Int = localDataSource.getFavMovieById(id)
    override fun getFavoriteSeriesById(id: String):Int = localDataSource.getFavSeriesById(id)
